...
# solving for the pseudo-pressure and pseudo-temperature for the entire mixture(hydrocarbon + non-hydrocarbon)



pseudo_critical_temp = ( 1 - (h2s_comp) - (co2_comp) - (n2_comp) - (h2o_comp)) * pseudo_critical_temp + (672.35*h2s_comp) + \
                                (547.58*co2_comp) + (227.16*n2_comp) + (11649*h2o_comp)



pseudo_critical_press = (1-(h2s_comp)- (co2_comp) - (n2_comp) - (h2o_comp))* pseudo_critical_press + (1306*h2s_comp) + \
                                (1071*co2_comp) + (493.1*n2_comp) + (3200*h2o_comp)




# displaying the results of the pseudo-critical pressure and temperature for the entire mixture
