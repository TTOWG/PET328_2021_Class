...
print('The pseudo-critical pressure is {0:.1f} psia'.format(pseudo_critical_press))
print('The pseudo-critical temperature is {0:.1f} deg Rankine'.format(pseudo_critical_temp))
 
# computing pseudo-pressure and pseudo-temperature for the entire mixture

pseudo_press = ((1- h2s_comp - co2_comp - n2_comp - h2o_comp)*(756.8 - (131*gas_gravity) - (3.6*gas_gravity**2)))+\
               (1306*h2s_comp)+(1071*co2_comp)+(493.1*n2_comp)+(3200*h2o_comp)

pseudo_temp = ((1-h2s_comp-co2_comp-n2_comp-h2o_comp)*(169.2 + (349.5*gas_gravity) - (74.0*gas_gravity**2)))+\
              (672.35*h2s_comp)+(547.58*co2_comp)+(227.16*n2_comp)+(1164.9*h2o_comp)

#displaying the results.
print('The pseudo-pressure is {0:.1f} psia'.format(pseudo_press))
print('The pseudo-temperature is {0:.1f} deg Rankine'.format(pseudo_temp))
