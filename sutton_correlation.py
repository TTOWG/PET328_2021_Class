...
# computing pseudo-critical pressure and temperature of the entire mixture
p_pc = ((1-h2s_comp-co2_comp-n2_comp-h2o_comp)*p_pch)+ \
       (1306*h2s_comp)+(1071*co2_comp)+(493.1*n2_comp)+(3200.1*h2o_comp)

t_pc = ((1-h2s_comp-co2_comp-n2_comp-h2o_comp)*t_pch)+ \
...
print('The pseudo-critical pressure for the entire mixture is {0:.2f} psia'.format(p_pc))
print('The pseudo-critical temperature for the entire mixture is {0:.2f} deg Rankine'.format(t_pc))
