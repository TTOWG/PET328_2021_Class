...
pseudo_pressure = ((1-h2s_comp-h2o_comp-n2_comp-co2_comp)* pseudo_critical_press) \
                  + 1306 * h2s_comp + 1071 * co2_comp + 493.1 * n2_comp + 3200.1 * h2o_comp
pseudo_temp = ((1-h2s_comp-h2o_comp-n2_comp-co2_comp)* pseudo_critical_temp) \
                  + (672.35 * h2s_comp) + (547.58 * co2_comp) + \
