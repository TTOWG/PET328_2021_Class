...
# computing pseudo-pressure and pseudo-temperature for the entire mixture (hydrocarbon + non-hydrocarbon) 
 
seudo_critical_press=((1- h2s_comp-co2_comp-n2_comp-h2o_comp)*pseudo_critical_press)+1306*h2s_comp+1071*co2_comp+493.1*n2_comp+3200.1*h2o_comp
seudo_critical_temp=((1-h2s_comp-co2_comp-n2_comp-h2o_comp)*pseudo_critical_temp)+672.35*h2s_comp+547.58*co2_comp+227.16*n2_comp+1164.9*h2o_comp

# displaying the results.
print('The pseudo-critical pressure is {0:.2f} psia'.format(seudo_critical_press))
print('The pseudo-critical temperature is {0:.2f} deg Rankine'.format(seudo_critical_temp))
